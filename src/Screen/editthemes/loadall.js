      ...
      case "padding":
        return (
          <li key={index}>
            ...
            <br />
            Right:&nbsp;
            <input type="number" value={sty[s].right} 
            onChange={(e) => {
              hadlechange("padding", { name: "right", value: e.target.value });
            }}
            />
            <br />
            Left:&nbsp;
            <input type="number" value={sty[s].left} onChange={(e) => {
                hadlechange("padding", { name: "left", value: e.target.value });
              }}/>
            <br />
            Bottom:&nbsp;
            <input type="number" value={sty[s].bottom} onChange={(e) => {
                hadlechange("padding", { name: "bottom", value: e.target.value });
              }} />
      ...
      case "margin":
          return (
            <li key={index}>
              ...
              Bottom:&nbsp;
              <input type="number" value={sty[s].bottom} onChange={(e) => {
                  hadlechange("margin", { name: "bottom", value: e.target.value });
                }} />
